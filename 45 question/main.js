...
let quote = "“Khudi ko kar buland itna ke har taqder se pehle Khuda bande se khud pooche bata teri raza kya hai.”";
...
let Lname = "Rehman";
let sirName = "Rashid";
let fullName = Fname + " " + Lname + " " + sirName;
...
let str = "My name is AbduLRehman.";
console.log(str.length);
// =====================================================================================================================
// 11- Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.
let names = ["Osaid", "Moiz", "Hasan", "Huzaifa", "Hassan"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
let namess = ["Osaid", "Moiz", "Hasan", "Huzaifa", "Hassan"];
for (let i of namess) {
...
for (let i of favTransport) {
    console.log("These are my favorite bike and car; I will buy them in the future.", i);
}
// 14- Guest List: If you could invite anyone, living or deceased, to dinner, who would you invite? Make a list that includes at least three people you’d like to invite to dinner. Then use your list to print a message to each person, inviting them to dinner.
let guest = ["Osaid", "Moiz", "Hassan"];
for (let i of guest) {
...
// create an Array.
let ListOfGuest = ["Osaid", "Moiz", "Hassan"];
...
console.log("Order of the original list (after reversing again):", orignalArray);
// STEP 09:
...
let inviteGusts = ["Osaid", "Moiz", "Hassan"];
...
// Test 03 & 04:
let greet = "hello";
console.log("greet === hello but greet === world. greet === hello: in this case is true, greet === world: in this case is false ");
console.log(greet === "hello"); // TRUE
console.log(greet === "world"); // FALSE
// Test 05 & 06:
let FirstName = "Abdul";
let LastName = "Rehman";
console.log(`FirstName === "Abdul" && LastName === "Rehman" :In this condition, I predict is true but FirstName === "Rehman" && LastName === "Abdul" in this condition I predict is false. `);
...
console.log((value1 === value4 && value1 !== value2) ||
    (value3 === value2 && value4 === value3)); // true
...
let users = ["Admin1", "Admin2", "Admin3", "Admin4", "Admin5"];
if (users.length === 0) {
...
// • If the list is empty, print the message We need to find some users!
// • Remove all of the usernames from your array, and make sure the correct message is printed.
let user = ["Admin1", "Admin2", "Admin3", "Admin4", "Admin5"];
while (user.length > 0) {
    let result = user.pop();
...
function makeShirtDefault(size = "Large", message = "I love TypeScript") {
    console.log(`Shirt size: ${size}, Message: ${message}`);
}
...
const greatMagicians = makeGreat(magicians.slice()); // Create a copy to preserve original
showMagicians(greatMagicians);
// =====================================================================================================================
// 43 - Unchanged Magicians: Start with your work from Exercise 40. Call the function make_great() with a copy of the array of magicians’ names. Because the original array will be unchanged, return the new array and store it in a separate array. Call show_magicians() with each array to show that you have one array of the original names and one array with the Great added to each magician’s name.
const originalMagicians = ["Merlin", "Gandalf", "Harry Potter"];
const modifiedMagicians = makeGreat(originalMagicians.slice()); // Create a copy to preserve original
